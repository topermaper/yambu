...
public class SendNotificationFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mActionBar.setSubtitle("Send notification");
    ...
    class EnviarMensaje extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            Log.i("mensaje", "Se va a enviar el mensaje: " + msg);
            ...
            String separator =",";//separamos por coma, como son todo integers nos da igual
            for (int i = 0; i < listaFollowers.size(); i++) {//recorremos todo y si lo hemos marcado lo enviamos
                if (listaFollowers.get(i).isChecked()) {//necesitamos la regid, no la devid para enviar un mensaje
